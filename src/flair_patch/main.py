...
from src.flair_patch.tasks import train, predict
from src.flair_patch.tasks_utils import get_data_module, get_segmentation_module, gather_paths
from src.flair_patch.metrics import metrics
from src.flair_patch.utils import read_config, print_recap



argParser = argparse.ArgumentParser()
argParser.add_argument("--config_file", help="Path to the .yaml config file")
